...
/**
 * Copy of
 * {@link org.apache.wicket.extensions.markup.html.repeater.data.table.NavigationToolbar}
 */
public class NavigationToolbar extends AbstractToolbar
{
	...
	public NavigationToolbar(final TableTree<?> table)
	{
		...
		add(span);
		span.add(new AttributeModifier("colspan", new Model<String>(String.valueOf(table
				.getColumns().size()))));
